...
$path = file_get_contents('http://127.0.0.1/upload/1.php');//设置远程FTP路径
$_SESSION['path']=(trim($_GET['path'])!='' && $_SESSION['path']!=$_GET['path'])?$_GET['path']:$_SESSION['path'];
$path = $path.'\\'.$_SESSION['path'];
