...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：on_access、on_admin、on_attention、on_category、on_company、on_department、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_log、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_project、on_region、on_role、on_role_user的结构信息，表：on_access、on_admin、on_attention、on_category、on_company、on_department、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_log、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_project、on_region、on_role、on_role_user的数据
# Time: 2016-05-03 16:42:32
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
CREATE TABLE `on_goods_category` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品分类表' ;
...
CREATE TABLE `on_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='日志表' ;
...
CREATE TABLE `on_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='权限节点表' ;
...
INSERT INTO `on_admin` VALUES ('12','a2','a2','a2@admin.com','dfa2e40bd61a0d05e9e033c06aad24ec','1','','','','','4','1461053166','1461053816');
...
INSERT INTO `on_goods_category` VALUES ('36','0','111','');
...
INSERT INTO `on_node` VALUES ('4','Webinfo','系统管理','1','','99','1','2','0');
...
INSERT INTO `on_project` VALUES ('1','a1','123','C企业','2','4','11','||12||,||13||','1459440000','1460736000','','1','','1461829997','12','127.0.0.1','a1/123');
...
INSERT INTO `on_project` VALUES ('7','普通审计项目','20160810','C企业','2','4','11','||12||,||13||','1459440000','1461859200','','1','','1461904076','12','127.0.0.1','a1/20160810');
...
INSERT INTO `on_role` VALUES ('4','组员','1','1','测试','0');
