...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：on_access、on_admin、on_attention、on_category、on_company、on_department、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_log、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_project、on_projectfile、on_region、on_role、on_role_user的结构信息，表：on_access、on_admin、on_attention、on_category、on_company、on_department、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_log、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_project、on_projectfile、on_region、on_role、on_role_user的数据
# Time: 2016-07-01 10:27:13
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
CREATE TABLE `on_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='日志表' ;
...
CREATE TABLE `on_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='权限节点表' ;
...
INSERT INTO `on_log` VALUES ('60','Public','index','用户登陆','10','127.0.0.1','1467340027');
...
INSERT INTO `on_project` VALUES ('7','普通审计项目2','20160811','C企业','2','4','12','||11||,||13||','1459094400','1461340800','','0','123','1462848032','10','127.0.0.1','a1/20160811');
