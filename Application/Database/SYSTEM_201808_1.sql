...
CREATE TABLE `on_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=211 DEFAULT CHARSET=utf8 COMMENT='日志表' ;
...
INSERT INTO `on_log` VALUES ('210','Public','index','','10','127.0.0.1','1533641319');
...
INSERT INTO `on_node` VALUES ('108','Company','审计对象','1','','4','1','2','1');
