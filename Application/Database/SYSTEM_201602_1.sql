...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：on_access、on_admin、on_advertising、on_advertising_position、on_attention、on_auction、on_auction_pledge、on_auction_record、on_category、on_feedback、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_pay、on_region、on_role、on_role_user的结构信息，表：on_access、on_admin、on_advertising、on_advertising_position、on_attention、on_auction、on_auction_pledge、on_auction_record、on_category、on_feedback、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_member、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_mysms、on_navigation、on_news、on_node、on_pay、on_region、on_role、on_role_user的数据
# Time: 2016-02-17 09:30:05
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
CREATE TABLE `on_goods_filtrate` (
  ...
  PRIMARY KEY (`fid`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品筛选条件表' ;
...
CREATE TABLE `on_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=104 DEFAULT CHARSET=utf8 COMMENT='权限节点表' ;
...
# 数据库表：on_admin 数据信息
INSERT INTO `on_admin` VALUES ('10','admin','admin@admin.com','1fdc80e84ed19bc053f0ddfc81915dd9','1','','','');
INSERT INTO `on_admin` VALUES ('11','','a1@admin.com','7acee465a453644dfd9415b3be904e46','1','','','1455498137');
...
# 数据库表：on_node 数据信息
INSERT INTO `on_node` VALUES ('1','Admin','后台管理','1','网站后台管理项目','10','0','1','1');
INSERT INTO `on_node` VALUES ('2','Index','管理首页','1','','1','1','2','1');
INSERT INTO `on_node` VALUES ('3','Member','注册用户管理','1','','3','1','2','1');
INSERT INTO `on_node` VALUES ('4','Webinfo','系统管理','1','','7','1','2','1');
...
INSERT INTO `on_node` VALUES ('10','index','站点信息','1','','10','4','3','0');
INSERT INTO `on_node` VALUES ('11','setEmailConfig','邮箱配置','1','','12','4','3','0');
INSERT INTO `on_node` VALUES ('12','testEmailConfig','发送测试邮件','1','','0','4','3','0');
INSERT INTO `on_node` VALUES ('13','setSafeConfig','系统安全设置','1','','0','4','3','0');
...
INSERT INTO `on_node` VALUES ('51','index','商品列表','1','商品列表的显示','0','50','3','0');
INSERT INTO `on_node` VALUES ('52','add','添加商品','1','添加商品','0','50','3','0');
INSERT INTO `on_node` VALUES ('53','category','频道分类管理','1','添加频道或分类的权限','0','50','3','0');
INSERT INTO `on_node` VALUES ('54','filtrate','筛选条件管理','1','添加编辑筛选条件的权限','0','50','3','0');
INSERT INTO `on_node` VALUES ('55','cate_filt','频道、分类与筛选条件关联','1','频道、分类与筛选条件关联','0','50','3','0');
INSERT INTO `on_node` VALUES ('56','fields_list','商品扩展字段列表','1','商品扩展字段列表','0','50','3','0');
INSERT INTO `on_node` VALUES ('57','cate_extend','频道、分类与扩展字段关联','1','频道、分类与扩展字段关联的操作','0','50','3','0');
INSERT INTO `on_node` VALUES ('58','del_goods','删除商品','1','商品的删除操作','0','50','3','0');
INSERT INTO `on_node` VALUES ('59','delLink','频道、分类与筛选条件关联的删除','1','频道、分类与筛选条件关联的删除','0','50','3','0');
INSERT INTO `on_node` VALUES ('60','fields_add','添加编辑扩展字段','1','扩展字段的添加和编辑','0','50','3','0');
INSERT INTO `on_node` VALUES ('61','delField','删除扩展字段','1','扩展字段的删除','0','50','3','0');
INSERT INTO `on_node` VALUES ('62','delExtend','频道、分类与扩展字段关联的删除','1','频道、分类与扩展字段关联的删除','0','50','3','0');
INSERT INTO `on_node` VALUES ('95','setUserAgreement','用户协议','1','用户协议管理','0','4','3','0');
INSERT INTO `on_node` VALUES ('96','navigation','导航链接管理','1','导航链接管理','0','4','3','0');
INSERT INTO `on_node` VALUES ('97','steWebConfig','站点配置','1','配置站点的信息','0','4','3','0');
INSERT INTO `on_node` VALUES ('98','setNoteConfig','短信配置','1','配置短信接口','0','4','3','0');
INSERT INTO `on_node` VALUES ('99','testNoteConfig','发送测试短信','1','发送测试短信','0','4','3','0');
INSERT INTO `on_node` VALUES ('100','setUserAgreement','用户协议','1','编辑用户协议','0','4','3','0');
